  ...
  return (
    ...
    >
      ...
      <div className="space-y-1">
        {/* Store Name */}
        <p className="text-xs text-yellow-400 uppercase font-bold font-gotham-bold">{product.store}</p>
        
        {/* Product Name */}
        <Link href={`/produto/${product.id}`}>
          <h3 className="font-bold text-sm leading-tight uppercase text-white font-gotham-bold">
            {product.name}
          </h3>
        </Link>
        ...
        <div className="flex items-center space-x-2">
          <span className="text-lg font-bold text-white font-gotham-black">R$ {product.price.toFixed(2).replace(".", ",")}</span>
        ...
        {/* Payment Terms */}
        <div className="text-xs text-yellow-400 font-semibold font-gotham-bold">3X SEM JUROS</div>
        
        {/* Sales Count */}
        <div className="text-xs text-gray-400 font-medium font-gotham-medium">{product.sold} VENDIDOS</div>
      </div>
    </div>
  )
}
